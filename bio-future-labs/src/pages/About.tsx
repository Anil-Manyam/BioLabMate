...
// import { motion } from 'framer-motion';
// import { Quote, Users, Leaf, Lightbulb, Award, Target, Eye, Trophy, Globe, Heart, Droplets, Wind, Sprout } from 'lucide-react';
// import Navigation from '@/components/Navigation';
// import Footer from '@/components/Footer';
...
//                 : 'bg-gradient-to-r from-teal-400/30 to-emerald-400/30'
//             }`}
//           />
//         ))}
//       </>
...
//             ease: 'easeInOut',
//           }}
//           className="absolute top-1/4 left-1/4 w-96 h-96 bg-gradient-to-br from-emerald-300/25 via-cyan-300/20 to-transparent rounded-full blur-3xl"
//         />
//         <motion.div
//           animate={{
//             x: [0, -100, 50, 0],
...
//             delay: 5,
//           }}
//           className="absolute bottom-1/3 right-1/4 w-80 h-80 bg-gradient-to-br from-cyan-300/25 via-blue-300/20 to-transparent rounded-full blur-3xl"
//         />
//         <motion.div
//           animate={{
//             x: [0, 50, -100, 0],
...
//             delay: 10,
//           }}
//           className="absolute top-2/3 right-1/3 w-72 h-72 bg-gradient-to-br from-teal-300/25 via-emerald-300/20 to-transparent rounded-full blur-3xl"
//         />
//       </>
//     );
//   };
...
//         style={{
//           background: `
//             radial-gradient(at 20% 50%, rgba(16, 185, 129, 0.15) 0px, transparent 50%),
//             radial-gradient(at 80% 80%, rgba(6, 182, 212, 0.15) 0px, transparent 50%),
//             radial-gradient(at 40% 80%, rgba(34, 197, 94, 0.15) 0px, transparent 50%),
//             radial-gradient(at 90% 20%, rgba(14, 165, 233, 0.15) 0px, transparent 50%),
//             radial-gradient(at 30% 30%, rgba(5, 150, 105, 0.15) 0px, transparent 50%)
//           `,
...
//           </pattern>
//           <motion.radialGradient id="gridGradient" cx="50%" cy="50%" r="50%">
...
//         <div className="absolute inset-0 bg-gradient-to-br from-slate-50 via-emerald-50/50 to-cyan-50" />
...
//             ease: 'easeInOut',
//           }}
//           className="absolute top-1/3 left-1/3 w-96 h-96 bg-gradient-to-r from-emerald-200/10 to-cyan-200/10 rounded-full blur-3xl"
//         />
//       </div>
...
//               >
//                 <motion.div
//                   className="bg-white/70 backdrop-blur-xl rounded-2xl p-8 shadow-2xl border border-emerald-100/50 relative overflow-hidden"
...
//             >
//               <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">Meet Our Founders</h2>
//               <motion.div
//                 animate={{
//                   width: ['0%', '100%'],
//                 }}
//                 transition={{ duration: 1, delay: 0.3 }}
//                 className="w-24 h-1 bg-gradient-to-r from-emerald-600 to-cyan-600 mx-auto rounded-full"
//               />
//             </motion.div>
...
//               >
//                 <motion.div
//                   className="bg-gradient-to-br from-emerald-100/50 to-cyan-100/50 backdrop-blur-xl rounded-2xl p-8 border border-emerald-200/50 hover:shadow-2xl transition-all duration-500 relative overflow-hidden"
...
//                     animate={{
//                       background: [
//                         'linear-gradient(45deg, transparent, rgba(16, 185, 129, 0.05), transparent)',
//                         'linear-gradient(225deg, transparent, rgba(16, 185, 129, 0.05), transparent)',
//                       ],
//                     }}
...
//                     </motion.div>
//                     <div>
//                       <h3 className="text-2xl font-bold text-gray-900 mb-1">Sanjay</h3>
//                       <p className="text-emerald-600 font-semibold">Co-Founder & Researcher</p>
//                     </div>
//                   </div>
//                 </motion.div>
//               </motion.div>
...
//               >
//                 <motion.div
//                   className="bg-gradient-to-br from-cyan-100/50 to-teal-100/50 backdrop-blur-xl rounded-2xl p-8 border border-cyan-200/50 hover:shadow-2xl transition-all duration-500 relative overflow-hidden"
//                   whileHover={{ scale: 1.02, y: -5 }}
//                   whileInView={{ scale: 1 }}
//                   transition={{ duration: 0.3 }}
//                   viewport={{ once: false }}
...
//                     </motion.div>
//                     <div>
//                       <h3 className="text-2xl font-bold text-gray-900 mb-1">Sarika</h3>
//                       <p className="text-cyan-600 font-semibold">Co-Founder & Researcher</p>
//                     </div>
//                   </div>
//                 </motion.div>
//               </motion.div>
...
//             >
//               <motion.div
//                 className="bg-gradient-to-br from-emerald-600 via-teal-600 to-cyan-600 rounded-3xl p-8 md:p-12 text-white shadow-2xl relative overflow-hidden"
...
//                     <Quote className="w-8 h-8 text-white/80 flex-shrink-0" />
//                     <h3 className="text-3xl md:text-4xl font-bold text-center">Our Mission & Commitment</h3>
//                   </div>
//                   <blockquote className="text-lg md:text-xl leading-relaxed italic text-center text-white/95">
//                     "We are trying to make a seaweed bioplastic that stands out as a promising alternative. They are renewable, biodegradable, and have less environmental impact than any conventional plastic we use. With a competent team and strong support from the scientific community, we are determined to eradicate petroleum-based plastics from research labs. We are fully committed to this cause and invite you to join us in building eco-sustainable products. Let's save our planet from harmful material and create a greener future..."
//                   </blockquote>
//                 </div>
//               </motion.div>
...
//               variants={scrollVariants}
//               transition={{ duration: 0.8, delay: 0.2 }}
//               className="bg-gradient-to-br from-emerald-100/60 to-cyan-100/60 backdrop-blur-xl rounded-3xl p-8 md:p-12 shadow-2xl border border-emerald-200/50 relative overflow-hidden"
//             >
//               <motion.div
//                 animate={{
//                   x: ['-100%', '100%'],
...
//                 >
//                   <motion.div
//                     className="bg-white/80 backdrop-blur-xl rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 border border-emerald-200/30 h-full relative overflow-hidden"
//                     whileInView={{ y: -10 }}
//                     whileHoverCapture={{ y: -15 }}
//                     transition={{ duration: 0.3 }}
//                     viewport={{ once: false }}
//                   >
//                     <motion.div
...
//                     />
//                     <div className="flex items-center justify-center w-16 h-16 bg-gradient-to-br from-emerald-600 to-cyan-600 rounded-2xl mb-6 group-hover:scale-110 transition-transform duration-300 relative z-10">
//                       <value.icon className="w-8 h-8 text-white" />
//                     </div>
...
//                 variants={scrollVariants}
//                 transition={{ duration: 0.8, delay: 0.4 }}
//                 className="bg-gradient-to-br from-cyan-600 to-blue-600 rounded-2xl p-8 text-white shadow-2xl relative overflow-hidden"
//               >
//                 <motion.div
//                   animate={{
//                     rotate: [360, 0],
...
//                     delay: 1
//                   }}
//                   className="absolute inset-0 bg-gradient-to-l from-transparent via-white/10 to-transparent pointer-events-none"
//                 />
//                 <div className="flex items-center gap-3 mb-6 relative z-10">
...
//               <motion.div
//                 className="bg-gradient-to-br from-amber-100/80 to-orange-100/80 backdrop-blur-xl rounded-2xl p-8 shadow-xl border border-amber-200/50 relative overflow-hidden"
...
//           {/* Animated Wave Patterns - Lite Colors */}
//           <motion.path
...
//             animate={{
//               d: [
//                 "M0,400 Q250,350 500,400 T1000,400",
//                 "M0,400 Q250,450 500,400 T1000,400",
//                 "M0,400 Q250,350 500,400 T1000,400",
//               ],
//             }}
//             transition={{
...
//             }}
//             style={{
//               transformOrigin: '900px 100px',
//             }}
//           />

//           {/* Star-like elements for space effect */}
//           <motion.circle cx="150" cy="50" r="2" fill="#7ee8c4" opacity="0.6" animate={{ opacity: [0.3, 0.8, 0.3] }} transition={{ duration: 3, repeat: Infinity, ease: "easeInOut" }} />
//           <motion.circle cx="800" cy="100" r="1.5" fill="#a5f3fc" opacity="0.6" animate={{ opacity: [0.3, 0.8, 0.3] }} transition={{ duration: 4, repeat: Infinity, ease: "easeInOut", delay: 0.5 }} />
//           <motion.circle cx="300" cy="450" r="2" fill="#c7d2fe" opacity="0.6" animate={{ opacity: [0.3, 0.8, 0.3] }} transition={{ duration: 3.5, repeat: Infinity, ease: "easeInOut", delay: 1 }} />
//           <motion.circle cx="950" cy="300" r="1.5" fill="#86efac" opacity="0.6" animate={{ opacity: [0.3, 0.8, 0.3] }} transition={{ duration: 4.5, repeat: Infinity, ease: "easeInOut", delay: 1.5 }} />
//         </svg>
//       </div>
