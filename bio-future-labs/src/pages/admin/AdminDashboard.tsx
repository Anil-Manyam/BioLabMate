// // AdminDashboard.tsx - Main dashboard with statistics and recent activities
...
// AdminDashboard.tsx - Main dashboard with statistics and recent activities
// UPDATED VERSION WITH PRODUCTS SUPPORT
...
interface DashboardStats {
  ...
  total_milestones: number;
  total_contacts: number;
  total_products: number;  // ✅ ADDED: Products count
  unread_contacts: number;
  recent_activities: Array<{
    type: string;
    action: string;
...
const AdminDashboard: React.FC = () => {
  ...
  const getActivityIcon = (type: string) => {
    switch (type) {
      ...
      case 'contact': return MessageSquare;
      case 'milestone': return MapPin;
      case 'product': return Package;  // ✅ ADDED: Product activity icon
      default: return Activity;
    }
  };
  ...
  return (
    <div className="space-y-8">
      ...
      {/* Stats Grid - Now shows 6 cards (including Products) */}
