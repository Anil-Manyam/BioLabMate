        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            ...
            <div className="flex-1 flex items-center">
              <Link to="/" className="flex items-center space-x-3">
                <img src={Logo} alt="Company Logo" className="h-10 w-auto" />
                {/* <span className="text-3xl font-bold text-white hover:text-primary-light transition-colors duration-300">
                  BioLabMate
                </span> */}
              </Link>
            </div>
            ...
            <div className="hidden md:flex space-x-10">
              ...
              {/* Comment out the entire block below to hide Service dropdown */}
              {/* <div className="relative" ref={serviceDropdownRef}>
                <button
                  onClick={() => setIsServiceDropdownOpen(!isServiceDropdownOpen)}
                  onMouseEnter={() => setIsServiceDropdownOpen(true)}
          ...
          {isOpen && (
            <div className="md:hidden absolute top-20 left-0 right-0 bg-black/90 backdrop-blur-md border-b border-white/10 shadow-soft">
              <div className="px-4 py-4 space-y-2">
                ...
                {/* Comment out this block as well to hide from mobile */}
                {/* <div className="border-t border-white/20 pt-2 mt-2">
                  <div className="px-4 py-2 text-white/70 text-sm font-medium">Service</div>
                  {serviceItems.map((item) => (
                    <button
...
// // // new transparent navigation code
// import { useState, useRef, useEffect } from 'react';
// import { Menu, X, ChevronDown } from 'lucide-react';
// import { Link, useLocation } from 'react-router-dom';
// import Logo from '@/assets/Logo.jpg';
...
//                 { label: 'Product', onClick: () => window.location.href = '/product' },
//               ].map((item) => (
//                 <button
//                   key={item.label}
//                   onClick={item.onClick}
//                   className="text-white/90 hover:text-white hover:scale-105 transition-all duration-300 font-medium text-lg relative
//                   after:content-[''] after:absolute after:w-0 after:h-0.5 after:bg-primary-light after:left-0 after:-bottom-1 
...
//                   onClick={() => setIsServiceDropdownOpen(!isServiceDropdownOpen)}
//                   onMouseEnter={() => setIsServiceDropdownOpen(true)}
//                   className="text-white/90 hover:text-white hover:scale-105 transition-all duration-300 font-medium text-lg 
//                   flex items-center gap-1 relative after:content-[''] after:absolute after:w-0 after:h-0.5 after:bg-primary-light 
...
//                 {isServiceDropdownOpen && (
//                   <div
//                     className="absolute top-full left-0 mt-2 w-64 bg-transparent border border-white/20 rounded-lg shadow-2xl py-2 z-50"
//                     onMouseLeave={() => setIsServiceDropdownOpen(false)}
//                   >
//                     {serviceItems.map((item) => (
//                       <button
...
//           {/* Mobile Navigation */}
//           {isOpen && (
//             <div className="md:hidden absolute top-20 left-0 right-0 bg-transparent border-b border-transparent shadow-none">
//               <div className="px-4 py-4 space-y-2">
//                 {[
//                   { label: 'Home', onClick: () => scrollToSection('hero') },
//                   { label: 'About', onClick: () => window.location.href = '/about' },
