...
//                   {/* Node circle */}
//                   <div
//                     className={`relative w-10 h-10 rounded-full border-4 transition-all duration-300 ${
//                       isActive
...
//5. journey through time with backend code
import { motion, AnimatePresence } from "framer-motion";
import { useEffect, useState, useRef } from "react";
import {
  Trophy,
    ...
    const fetchMilestones = async () => {
      try {
        ...
        const formatted: JourneyYear[] = Object.keys(grouped)
          ...
          .sort((a, b) => a.year - b.year); // ascending for timeline progression
